...
'lucene_queries' => "
	...
	CONSTRAINT	', CONSTRAINT `lucene_index_queries_ref` FOREIGN KEY (`lucene_id`) REFERENCES `".BIT_DB_PREFIX."lucene_indexes` (`lucene_id`)'
",
...
$indices = array (
	...
	'lucene_history_lucene_idx' => array( 'table' => 'lucene_indexes', 'cols' => 'lucene_id', 'opts' => '' ),
);
...
$gBitInstaller->registerUserPermissions( LUCENE_PKG_NAME, array(
	array('p_lucene_admin', 'Can administer the lucene search engine', 'admin', LUCENE_PKG_NAME),
	array('p_lucene_search', 'Can use the search engine', 'basic', LUCENE_PKG_NAME),
) );
